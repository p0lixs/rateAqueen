...
export default function CreateRoom() {
  ...
  return (
    <main className="shell">
      <div className="topbar"><a className="brand" href="/"><span className="brand-mark"><Crown size={18} /></span> Rate a Queen</a><a className="btn btn-soft" href="/"><ArrowLeft size={15} /> Mis salas</a></div>
      ...
      <form className="card" onSubmit={submit}>
        ...
        {queens.map((queen, index) => (
          <div className="repeat-row" key={index}>
            <label className="photo-input" title="Añadir foto opcional">
