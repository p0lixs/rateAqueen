...
type DisplayData = { title: string; description: string | null; owner_name: string | null; status: "registration" | "voting" | "results"; members: number; votes: number };
