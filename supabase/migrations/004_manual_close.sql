-- Ejecuta este archivo UNA VEZ después de 003_one_vote_per_account.sql.
-- La sala permanece abierta hasta que la administradora la cierre.
...
begin
  ...
  -- Bloquea la sala durante el envío: un cierre concurrente esperará al voto.
